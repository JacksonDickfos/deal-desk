      ...
      >
        <div className="flex items-start justify-between mb-2">
          <div className="flex-grow min-w-0 pr-2">
            <h3 className="text-base font-semibold text-gray-900 truncate leading-tight mb-[8px]">
              {deal.company}
            </h3>
            <div className="text-sm text-gray-600 mt-[2px]">
          ...
          <div className="flex flex-col items-end flex-shrink-0 w-[40px]">
            ...
            {deal.demo_date && (
              <span className="text-sm text-gray-500 mt-[8px]">
